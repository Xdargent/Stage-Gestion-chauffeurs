            ...
            <div class="grid gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <x-input-with-icon-wrapper>
                        ...
                        <x-input withicon id="telephone" class="block w-full" type="text" name="telephone" 
                            :value="old('telephone')" required placeholder="{{ __('Telephone') }}" />
                    </x-input-with-icon-wrapper>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <x-input-with-icon-wrapper>
                        ...
                        <x-input withicon id="cin" class="block w-full" type="text" name="cin"
                            :value="old('cin')"  placeholder="{{ __('Cin') }}" />
                    </x-input-with-icon-wrapper>
                </div>
